...
/**
 * Provides the block enable form.
 */
class BlockEnableForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to enable the %block block?', ['%block' => $this->entity->label()]);
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()
      ->addStatus($this->t('The %block block has been enabled.', ['%block' => $this->entity->label()]));
